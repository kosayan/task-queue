...
const days=[];for(let i=6;i>=0;i–){const d=new Date(now);d.setDate(d.getDate()-i);days.push({d:d,count:0,label:[“日”,“月”,“火”,“水”,“木”,“金”,“土”][d.getDay()]})}
tasks.forEach(t=>{if(!t.completedAt)return;const c=new Date(t.completedAt);c.setHours(0,0,0,0);days.forEach(dy=>{if(c.getTime()===dy.d.getTime())dy.count++})});
return days;
},[tasks,tick]);
