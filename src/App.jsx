...
const DEFAULTS_KEY = “task-queue-defaults”;
...
return raw ? { …DEFAULT_DEFAULTS, …JSON.parse(raw) } : DEFAULT_DEFAULTS;
    ...
    {[
      ...
      <button
        ...
        style={{
          ...
          color: filter === f.key && locationFilter === null ? "#000" : "#999",
        }}
        onClick={() => {
          setFilter(f.key);
      ...
      {pastLocations.map((loc) => (
        <button
          ...
          style={{
            ...
            color: locationFilter === loc ? "#000" : "#999",
          }}
  ...
  {showSettings && (
    <div style={styles.modalOverlay} onClick={() => setShowSettings(false)}>
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ ...styles.fieldGroup, borderTop: "1px solid #333", paddingTop: 16 }}>
          <label style={{ ...styles.fieldLabel, fontSize: 12, color: "#ccc", marginBottom: 14 }}>タスクのデフォルト値</label>
            ...
            <div style={styles.chipRow}>
              {IMPORTANCE.map((opt) => (
                <button
                  ...
                  style={{
                    ...styles.chip,
                    background: defaults.importance === opt.value ? opt.color : "#1a1a1a",
                    color: defaults.importance === opt.value ? "#fff" : "#888",
                    borderColor: defaults.importance === opt.value ? opt.color : "#333",
                  }}
                  onClick={() => setDefaults((d) => ({ ...d, importance: opt.value }))}
                >
                  {opt.label}
                </button>
              ))}
          ...
          <div style={styles.fieldGroup}>
            <label style={styles.fieldLabel}>重さ</label>
            <div style={styles.chipRow}>
              {WEIGHT.map((opt) => (
                <button
                  key={opt.value}
                  ...
                  style={{
                    ...styles.chip,
                    background: defaults.weight === opt.value ? opt.color : "#1a1a1a",
                    color: defaults.weight === opt.value ? "#000" : "#888",
                    borderColor: defaults.weight === opt.value ? opt.color : "#333",
                  }}
                  onClick={() => setDefaults((d) => ({ ...d, weight: opt.value }))}
                >
                  {opt.label}
                </button>
              ))}
          ...
          <div style={styles.fieldGroup}>
            <label style={styles.fieldLabel}>締切</label>
            <div style={styles.chipRow}>
              {[
                { value: true, label: "あり" },
                ...
                <button
                  ...
                  style={{
                    ...styles.chip,
                    background: defaults.hasDeadline === opt.value ? "#fff" : "#1a1a1a",
                    color: defaults.hasDeadline === opt.value ? "#000" : "#888",
                    borderColor: defaults.hasDeadline === opt.value ? "#fff" : "#333",
                  }}
                  onClick={() => setDefaults((d) => ({ ...d, hasDeadline: opt.value }))}
                >
                  {opt.label}
                </button>
              ))}
            ...
            <div style={styles.chipRow}>
              {RECURRENCE.map((opt) => (
                <button
                  ...
                  style={{
                    ...styles.chip,
                    background: defaults.recurrence === opt.value ? "#fff" : "#1a1a1a",
                    color: defaults.recurrence === opt.value ? "#000" : "#888",
                    borderColor: defaults.recurrence === opt.value ? "#fff" : "#333",
                  }}
                  onClick={() => setDefaults((d) => ({ ...d, recurrence: opt.value }))}
                >
                  {opt.label}
                </button>
              ))}
            ...
            <div style={styles.fieldGroup}>
              ...
              <div style={styles.chipRow}>
                <button
                  ...
                  style={{
                    ...styles.chip,
                    background: !defaults.location ? "#fff" : "#1a1a1a",
                    color: !defaults.location ? "#000" : "#888",
                    borderColor: !defaults.location ? "#fff" : "#333",
                  }}
                  onClick={() => setDefaults((d) => ({ ...d, location: "" }))}
                >
                  なし
                </button>
                {pastLocations.map((loc) => (
                  <button
                    ...
                    style={{
                      ...styles.chip,
                      background: defaults.location === loc ? "#fff" : "#1a1a1a",
                      color: defaults.location === loc ? "#000" : "#888",
                      borderColor: defaults.location === loc ? "#fff" : "#333",
                    }}
                    onClick={() => setDefaults((d) => ({ ...d, location: loc }))}
                  >
                    {loc}
                  </button>
                ))}
      ...
      <div style={styles.cardLeft}>
        <button
          ...
          style={{
            ...
            borderColor: task.done ? "#ff3b30" : "#555",
          }}
