...
const startPause=0.7,travelSpeed=90,endPause=2;
...
useEffect(()=>{
const last=ld(ABK,0);
const now=new Date();const todayKey=now.getFullYear()+String(now.getMonth()+1).padStart(2,“0”)+String(now.getDate()).padStart(2,“0”);
const lastKey=ld(ABK+”-day”,””);
if(last===0){sv(ABK,Date.now());sv(ABK+”-day”,todayKey);return}
if(lastKey!==todayKey&&tasks.length>=3){
setTimeout(()=>{
try{
...
sv(ABK,Date.now());sv(ABK+”-day”,todayKey);
}catch{}
},1500)
}
// eslint-disable-next-line
