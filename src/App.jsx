...
.btn-hover:hover, .btn-icon:hover, .btn-add:hover { filter: brightness(1.2); }
.btn-add:hover { border-color: #ff3b30 !important; color: #ff3b30 !important; background: rgba(255,59,48,0.05) !important; }
